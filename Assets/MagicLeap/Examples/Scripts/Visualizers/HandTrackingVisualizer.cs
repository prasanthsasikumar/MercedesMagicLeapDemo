...
namespace MagicLeap
{
    ...
    public class HandTrackingVisualizer : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("The transaprent material")]
        ...
        void Start()
        {
            ...
            {
                _indexFinger[i].gameObject.AddComponent<SphereCollider>();
                _indexFinger[i].gameObject.GetComponent<Collider>().isTrigger = true;
            }
        }
        ...
        private GameObject CreateKeyPoint(MLKeyPoint keyPoint, Color color)
        {
            ...
            newObject.GetComponent<Renderer>().material.color = new Color(1, 1, 1, .5f);
            newObject.tag = "touchPoints";
            //newObject.GetComponent<Renderer>().material = _transparentMaterial;
            return newObject;
        }
        #endregion
    }
